      ...
      <main>
        <section className="bg-[#dfc1b1]">
          <div className=" h-full lg:px-25 px-8 lg:pt-48 md:pt-36 pt-24 pb-24 flex flex-col gap-10">
            ...
            <p className='text-[18px] leading-11 font-light text-center lg:w-[940px] max-w-[600px] w-full mx-auto'>Parth and Zeel’s love feels effortless—like two people who just belong. Their photos capture quiet smiles, soft touches, and that unspoken connection you can’t fake. Every frame feels real, like a moment they forgot the camera was even there.</p>
            <p className='text-[18px] leading-11 font-light text-center lg:w-[940px] max-w-[600px] w-full mx-auto'>The vibe of their wedding was simple, elegant, and full of warmth. Set against nature and soft golden light, their story unfolded in the most grounded, beautiful way—nothing loud, just deeply personal.</p>
            <p className='text-[18px] leading-11 font-light text-center lg:w-[940px] max-w-[600px] w-full mx-auto'>What makes their story special isn’t grand gestures, but the way they look at each other. Calm, joyful, and completely in sync—just the way love should feel.</p>
